...
const Ratings = () => {
  return (
    <div className="flex flex-col gap-16 relative py-16 bg-blue-50 rounded-lg px-32 mx-8">
      ...
      <div className="bg-white relative flex items-center justify-center w-[40%] py-20 px-4 h-full mx-auto rounded-lg">
